            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                    ...
                    <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                        <h3 class="section-title">New Item</h3>
                        <div class="sidebar-widget-body outer-top-xs">
                            <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                                <div class="item">
                                    <div class="products special-product">
                                        @foreach(\App\Model\Product::latest()->paginate(3) as $product)
                                        <div class="product">
                    ...
                    <!-- ============================================== PRODUCT TAGS ============================================== -->
                    <br/>
                    <!-- ============================================== PRODUCT TAGS : END ============================================== --><!-- ============================================== SPECIAL DEALS : END ============================================== -->
                    <!-- ============================================== NEWSLETTER ============================================== -->
...
{{--                                                                </li>--}}
                                                                ...
                                                                <li class="lnk">
                                                                    <a data-toggle="tooltip" class="add-to-cart" href="{{url('/product/'.$product->id)}}" title="Quick View">
...
{{--                                                            <button class="btn btn-primary cart-btn addwish"  data-id="{{$product->id}}" type="button">Add to cart</button>--}}
                                                        </li>
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        ...
                                        <div class="blog-post-info text-left">
                                            ...
                                            <span class="info">By Hello User &nbsp;|&nbsp; {{$blog->created}} </span>
